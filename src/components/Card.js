    ...
    return (
        <div className="card">
            <img src={props.launch.links.mission_patch} alt={`Mission Patch`} style={{"width":"50%"}} />
                ...
                <h5><b>Successful Launch:</b> <span className="mission-details">{props.launch.mission_id !== ''? props.launch.mission_id: "Data not available"}</span></h5>
                <h5><b>Successful Landing:</b> <span className="mission-details">{props.launch.mission_id !== ''? props.launch.mission_id: "Data not available"}</span></h5>
        </div>
    )
}
